...
static void
mrb_hydro_sign_gem_init(mrb_state *mrb, struct RClass *hydro_mod, struct RClass *hydro_error_cl)
{
  ...
  mrb_define_class_under(mrb, hydro_sign_cl, "Error", hydro_error_cl);
